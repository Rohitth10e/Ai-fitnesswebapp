...
const generateNarrationText = (plan) => {
    ...
    text += `Your daily calorie target is ${aiPlan.dietPlan.dailyCalories}. `;
    text += `And your hydration goal is ${aiPlan.dietPlan.hydration}. `;

    text += "You can review the full details for each day in the plan below. Good luck!";
    return text;
};
    ...
    const handleNarration = () => {
        try {
            if (!('speechSynthesis' in window)) {
                throw new Error('Sorry, your browser does not support text-to-speech.');
            }
